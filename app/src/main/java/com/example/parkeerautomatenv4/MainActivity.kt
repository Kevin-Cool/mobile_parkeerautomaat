...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fragment = ParkeerautomaatLijstFragment()
        supportFragmentManager.beginTransaction().replace(R.id.fl_wrapper,fragment).setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN).commit()
